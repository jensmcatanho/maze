...
#  The below link will need to change depending on the version, this one is for 2017.3.0f3
...
curl --retry 5 -o Unity_win.pkg http://netstorage.unity3d.com/unity/a9f86dcd79df/MacEditorTargetInstaller/UnitySetup-Windows-Support-for-Editor-2017.3.0f3.pkg
if [ $? -ne 0 ]; then { echo "Download failed"; exit $?; } fi
